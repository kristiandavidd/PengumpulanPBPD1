        ...
        <div class="container">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <option value="none" <?php if (!isset($bloof_type) || $bloof_type == "") echo "selected";?>>--Select a blood_type--</option>
                    <option value="AB" <?php if (isset($blood_type) && $blood_type == "A") echo "selected";?>>A</option>
                    <option value="A" <?php if (isset($blood_type) && $blood_type == "B") echo "selected";?>>B</option>
                    <option value="B" <?php if (isset($blood_type) && $blood_type == "AB") echo "selected";?>>AB</option>
                    <option value="O" <?php if (isset($blood_type) && $blood_type == "O") echo "selected";?>>O</option>
                    </select>
                </div>
            </div>
