...
<div class="card mt-4">
    ...
    <div class="card-body">
        ...
        <table class="table table-striped">
            ...
            if (is_array($_SESSION['cart']) && count($_SESSION['cart']) > 0) {
                foreach ($_SESSION['cart'] as $ids => $qty) {
                    $query = "SELECT * FROM books WHERE isbn = '$ids'";
                ...
                echo '<tr><td colspan="5" align="right">Total</td><td>$' . $sum_price . '</td></tr>';
                $result->free();
                $db->close();
            } else {
        ...
        <!-- Tombol untuk melanjutkan belanja dan mengosongkan keranjang -->
        <a class="btn btn-primary" href="viewbooks.php">Continue Shopping</a>
