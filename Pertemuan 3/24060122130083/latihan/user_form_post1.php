...
<div class="bg-slate-600 mt-10 p-6 rounded-lg w-[40%] mx-auto">
    ...
    <form action="" autocomplete="on" method="POST" class="flex flex-col space-y-4">
        ...
        <div class="form-group">
            ...
            <div class="error mt-1"><?php if (isset($error_nama)) echo $error_nama; ?></div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="error mt-1"><?php if (isset($error_email)) echo $error_email; ?></div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="error mt-1"><?php if (isset($error_alamat)) echo $error_alamat; ?></div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="error mt-1"><?php if (isset($error_kota)) echo $error_kota; ?></div>
        </div>
        ...
        <div class="form-check">
            ...
            <div class="error mt-1"><?php if (isset($error_jenis_kelamin)) echo $error_jenis_kelamin; ?></div>
        </div>
        ...
        <div class="form-check">
            ...
            <div class="error mt-1"><?php if (isset($error_minat)) echo $error_minat; ?></div>
        </div>
