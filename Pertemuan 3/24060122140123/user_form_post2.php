        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" id="alamat" name="alamat"><?php echo isset($_POST['alamat']) ? $_POST['alamat'] : ''; ?></textarea>
                ...
                <div class="form-check">
                    <input type="checkbox" name="minat[]" class="form-check-input" value="coding" <?php if (isset($minat) && in_array('coding', $minat)) echo "checked"; ?>>
                    <label class="form-check-label">Coding</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" name="minat[]" class="form-check-input" value="ux_design" <?php if (isset($minat) && in_array('ux_design', $minat)) echo "checked"; ?>>
                    <label class="form-check-label">UX Design</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" name="minat[]" class="form-check-input" value="data_science" <?php if (isset($minat) && in_array('data_science', $minat)) echo "checked"; ?>>
