...
if (!$result) {
    ...
    <strong>Error!</strong> Could not query the database<br> " . $db->error . "</div>";
} else {
    // TODO 2: Jika sukses, tulislah response yang sesuai
    echo "<div class='alert alert-success alert-dismissible'>
    <strong>Success!</strong> Data has been added to the database<br> Name: " . $name . "<br> Address: " . $address . "<br> City: " . $city . "</div>";
}
