<!-- 
    Nama File   : add_customer_gets.php
    Deskripsi   : menambah customer
...
<?php
    ...
    if(!$result) {
        ...
        echo '<div class="alert alert-success alert-dismissible"><strong>Success!</strong> Data has been added.<br>Name: '.$_GET['name'].'<br>Address: '.$_GET['address'].'<br>City: '.$_GET['city'].'<br></div>';
    }
    $db->close();
?>